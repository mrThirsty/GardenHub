...
public class PlantService : BaseDataService<PlantService>, IPlantService
{
    public PlantService(IHttpClientFactory clientFactory, IMessageHandler msgHandler, ILogger<PlantService> logger) : base(clientFactory, msgHandler, logger)
    {
    }
